      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" ><hr>
            <form class="row g-3" action="proses_post.php" method="POST">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="suratpermohonan" class="form-control" id="suratpermohonan">
              </div>
              <div class="col-md-6">
                <label for="inputtanggal" class="form-label">Tanggal Surat Pemohonan</label>
                <input type="text" name="tanggalsurat" class="form-control" id="tanggalsurat">
              </div>
              <div class="col-md-6">
                <label for="inputState" class="form-label">Pemohon Merupakan</label>
                <select name="kepemilikan" id="inputState" class="form-select">
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary" href="profile">Simpan dan Lanjutkan</button>
              </div>
            </form>
          </div>
